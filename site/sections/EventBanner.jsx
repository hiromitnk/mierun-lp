...
function EventBannerDxpo() {
  return (
    <div className="mierun" style={{
      ...
      >
        {/* 左: ビッグ日付ブロック */}
        <div style={{ borderRight: '1px solid #efefef', paddingRight: 36 }}>
          <div className="en" style={{ fontSize: 13, color: '#FE5E32', letterSpacing: '0.18em', fontWeight: 800, marginBottom: 10 }}>
            2026 SUMMER
          </div>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, fontFamily: 'Inter, sans-serif', color: '#203954' }}>
            <span style={{ fontSize: 64, fontWeight: 800, lineHeight: 1, letterSpacing: '-0.03em' }}>8</span>
            <span style={{ fontSize: 28, fontWeight: 700, lineHeight: 1 }}>/</span>
            <span style={{ fontSize: 64, fontWeight: 800, lineHeight: 1, letterSpacing: '-0.03em' }}>18</span>
            <span style={{ fontSize: 22, fontWeight: 700, marginLeft: 4, color: '#7B768F' }}>Tue</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, fontFamily: 'Inter, sans-serif', color: '#203954', marginTop: 4 }}>
            <span style={{ fontSize: 28, fontWeight: 700, lineHeight: 1, color: '#7B768F' }}>—</span>
            <span style={{ fontSize: 64, fontWeight: 800, lineHeight: 1, letterSpacing: '-0.03em' }}>8</span>
            <span style={{ fontSize: 28, fontWeight: 700, lineHeight: 1 }}>/</span>
            <span style={{ fontSize: 64, fontWeight: 800, lineHeight: 1, letterSpacing: '-0.03em' }}>19</span>
            <span style={{ fontSize: 22, fontWeight: 700, marginLeft: 4, color: '#7B768F' }}>Wed</span>
          </div>
        </div>
        ...
        <div>
          ...
          <h3 style={{ fontSize: 28, fontWeight: 800, color: '#203954', lineHeight: 1.3, marginBottom: 16 }}>
            製造イノベーションDXPO<br/>
            <span style={{ fontSize: 18, fontWeight: 700, color: '#4A4664' }}>に出展します。</span>
          </h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, fontSize: 20, color: '#4A4664' }}>
            <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
              <span style={{
                width: 64,
                fontSize: 13, fontWeight: 800, color: '#FE5E32',
                letterSpacing: '0.14em',
                fontFamily: 'Inter, sans-serif',
              }}>PLACE</span>
              <span style={{ fontWeight: 700, color: '#0E0A2E', fontSize: 20 }}>
                東京ビッグサイト 西1・2・3ホール
              </span>
            </div>
            <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
              ...
              <span style={{ color: '#0E0A2E', fontWeight: 600, fontSize: 19 }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', fontSize: 14, fontWeight: 700, color: '#203954', lineHeight: 1.5 }}>
            来場登録は<br/>公式サイトへ →
          </div>
        </div>
      </a>
